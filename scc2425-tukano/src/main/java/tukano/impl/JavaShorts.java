...
public class JavaShorts implements Shorts {
    ...
    public Result<Short> getShort(String shortId) {
        ...
        if (cacheOn) {
            ...
            like = (Result<List<Long>>) this.queryInCache(query, "likes",
                    Long.class);

            shortRes = this.geFromCache(shortId, like);

        } else {

            if (sqlOn) {

                like = Result.ok(DB.sql(query, Long.class));
                shortRes = errorOrValue(DB.getOne(shortId, Short.class),
                        shrt -> shrt.copyWithLikes_And_Token(like.value().get(0)));

            } else {

                like = CosmosDBLikes.query(query, Long.class);
        ...
        return errorOrResult(this.getShort(shortId), shrt -> {
            ...
            return errorOrResult(okUser(shrt.getOwnerId(), password), user -> {
                ...
                if (sqlOn) {
                    ...
                    Result<List<Likes>> result1 = (Result<List<Likes>>) this.queryInCache(query, "likes", Likes.class);
    ...
    public Result<List<String>> getShorts(String userId) {
        ...
        if (cacheOn) {
            Result<List<String>> data = (Result<List<String>>) this.queryInCache(query, "shorts",
                    String.class);
            dataDB = data.value();
        }
            ...
            if (sqlOn)
                dataDB = DB.sql(query, String.class);
            else
                dataDB = CosmosDBShorts.query(query, String.class).value();

        }

        for (String str : dataDB) {
    ...
    public Result<List<String>> followers(String userId, String password) {
        ...
        Result<List<String>> data = (Result<List<String>>) this.queryInCache(query, "followers",
                String.class);
    ...
    public Result<List<String>> likes(String shortId, String password) {
        ...
        return errorOrResult(getShort(shortId), shrt -> {
            ...
            Result<List<String>> data = (Result<List<String>>) this.queryInCache(query, "likes",
                    String.class);
    ...
    public Result<List<String>> getFeed(String userId, String password) {
        ...
        Result<List<Short>> data = (Result<List<Short>>) this.queryInCache(query1, "shorts", Short.class);
        ...
        Result<List<String>> data2 = (Result<List<String>>) this.queryInCache(query2, "followers",
                String.class);
        ...
        for (String s : data2.value()) {
            ...
            Result<List<Short>> data3 = (Result<List<Short>>) this.queryInCache(query3, "shorts",
                    Short.class);
    ...
    public Result<Void> deleteAllShorts(String userId, String password, String token) {
        ...
        Result<List<Short>> data = (Result<List<Short>>) this.queryInCache(query1, "shorts",
                Short.class);
        ...
        Result<List<Following>> data2 = (Result<List<Following>>) this.queryInCache(query2, "followers",
                Following.class);
        ...
        Result<List<Likes>> data3 = (Result<List<Likes>>) this.queryInCache(query3, "likes", Likes.class);
    ...
    private <T> Result<?> queryInCache(String query, String containerName, Class<T> clazz) {
    ...
    private Result<Short> geFromCache(String id, Result<List<Long>> like) {
