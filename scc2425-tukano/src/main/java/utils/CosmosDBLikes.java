...
public class CosmosDBLikes {
    ...
    private static Logger Log = Logger.getLogger(CosmosDBLikes.class.getName());

    // private static String containerName;

    private static final String CONTAINERNAME = "likes";

    private static CosmosDBLikes instance;
    private CosmosClient client;
    private CosmosDatabase db;
    private CosmosContainer container;

    public static synchronized CosmosDBLikes getInstance() {
        if (instance != null) {
            return instance;
        }
         ...
         */
        instance = new CosmosDBLikes(client);

        return instance;

    }

    public CosmosDBLikes(CosmosClient client) {
        this.client = client;
    }
